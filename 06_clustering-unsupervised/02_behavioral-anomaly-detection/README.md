...
**ML Problem**: Unsupervised anomaly detection in user activity patterns
...
cd 06_clustering-unsupervised/02_behavioral-anomaly-detection
...
```
02_behavioral-anomaly-detection/
├── README.md
