...
**ML Problem**: Systematic prompt optimization and few-shot learning
...
cd 08_generative-ai-llms/05_prompt-engineering-framework
...
```
05_prompt-engineering-framework/
├── README.md
